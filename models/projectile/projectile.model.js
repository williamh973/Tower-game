...
export class Projectile {
    ...
    calculateDistance() {
        const dx = this.missileTarget.position.x + this.missileTarget.width / 2 - this.position.x;
        const dy = this.missileTarget.position.y + this.missileTarget.height / 2 - this.position.y;
    ...
    collide(missileTarget) {
        if (
            ...
            this.position.y <=
                missileTarget.position.y + missileTarget.height &&
